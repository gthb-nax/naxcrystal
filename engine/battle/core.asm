...
BattleTurn:
	ldh a, [hInMenu]
	push af
	xor a ; prevents continuous scrolling in move menu
	ldh [hInMenu], a
...
.CheckMagikarpArea:
	...
	jr nz, .Happiness ; fixed bug by turning jr z to nz, Rage of Lake ones are big again
	ld a, [wMapNumber]
	cp MAP_LAKE_OF_RAGE
	jr nz, .Happiness ; same fix
