...
PlayersHouseRadioScript:
		opentext
	; from https://github.com/xaerochill/timecrystal/commit/7a0eb1f8a9ae1168c0a2e384a45d26d06d1deb1e#diff-0b7d6896c2a1908426662abbc1d82bd12e8b70e86c1791d7c49c97ca84d5ce09R48
	; except for e4 cleared
	; unlock stationary legendaries
	setevent ENGINE_UNLOCKED_UNOWNS_A_TO_K
	; full pokegear
	...
	; good party
	givepoke NIDOKING, 99, MIRACLEBERRY
	givepoke ENTEI, 99, MIRACLEBERRY
	; hm tools
	givepoke MEW, 99, MIRACLEBERRY
	givepoke KINGLER, 99, MIRACLEBERRY
	loadmem wPartyMon1Moves+0, THUNDERBOLT
	loadmem wPartyMon1Moves+1, ICE_BEAM
	loadmem wPartyMon1Moves+2, EARTHQUAKE
	loadmem wPartyMon1Moves+3, SURF
	...
	loadmem wPartyMon3Moves+1, WHIRLPOOL
